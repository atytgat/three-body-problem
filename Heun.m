...
for s = 1:N
    ...
    % Distances entre les corps AJOUTER NORMES
    ...
    for i=1:3
        ...
        % Prédictions des positions
        x1pred(1,i) = x1(s,i) + k*dQ(p1(s,i),m1);
        x2pred(1,i) = x2(s,i) + k*dQ(p2(s,i),m2);
        x3pred(1,i) = x3(s,i) + k*dQ(p3(s,i),m3);
    ...
    % Prédictions des distances
    r12pred = norm(x1pred-x2pred);
    r13pred = norm(x1pred-x3pred);
    r23pred = norm(x2pred-x3pred);
    ...
    for i =1:3
        ...
        p1(s+1,i) = p1(s,i) + k/2*( dP(1,x1(s,i),x2(s,i),x3(s,i),r12,r13,r23) + dP(1,x1pred(1,i),x2pred(1,i),x3pred(1,i),r12pred,r13pred,r23pred) );
        p2(s+1,i) = p2(s,i) + k/2*( dP(2,x1(s,i),x2(s,i),x3(s,i),r12,r13,r23) + dP(2,x1pred(1,i),x2pred(1,i),x3pred(1,i),r12pred,r13pred,r23pred) );
        p3(s+1,i) = p3(s,i) + k/2*( dP(3,x1(s,i),x2(s,i),x3(s,i),r12,r13,r23) + dP(3,x1pred(1,i),x2pred(1,i),x3pred(1,i),r12pred,r13pred,r23pred) );
